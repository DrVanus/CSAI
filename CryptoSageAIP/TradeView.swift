...
struct TradeView: View {
    ...
    @ViewBuilder
    private var orderPlacementCard: some View {
    ...
    @ViewBuilder
    private var advancedOrderBook: some View {
        CardView(cornerRadius: 6, paddingAmount: 6) {
    ...
    @ViewBuilder
    private var advancedDepthChart: some View {
        CardView(cornerRadius: 6, paddingAmount: 6) {
            VStack(alignment: .leading, spacing: 6) {
    ...
    @ViewBuilder
    private var advancedExchangeIntegration: some View {
        CardView(cornerRadius: 6, paddingAmount: 6) {
            VStack(alignment: .leading, spacing: 6) {
